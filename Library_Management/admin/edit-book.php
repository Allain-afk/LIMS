...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $price = $_POST['price'];
        $stock = $_POST['stock'];
        $sql = "update tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,BookPrice=:price,Stock=:stock where id=:bookid";
                                    ...
                                    foreach ($results as $result) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="stock"
                                                value="<?php echo htmlentities($result->Stock); ?>" required="required" />
                                        </div>
